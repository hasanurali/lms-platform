  ...
  return (
    <Box sx={{ background: "#f7f9fb", color: "#191c1e", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <Box sx={{ pt: "64px" }}>
        ...
        <Box sx={{
          ...
          <Box sx={{ maxWidth: 1200, mx: "auto", display: "grid", gridTemplateColumns: { xs: "1fr", lg: "1fr 1fr" }, gap: { xs: 6, lg: 12 }, alignItems: "center", position: "relative", zIndex: 1 }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
              ...
              {/* CTA */}
              <Box sx={{ pt: 1 }}>
                <Button sx={{ px: 4, py: 1.75, background: "white", color: "#1a146b", borderRadius: "8px", fontFamily: "'DM Sans', sans-serif", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", fontSize: 12, boxShadow: "0 8px 24px rgba(0,0,0,0.2)", "&:hover": { background: "#89f5e7" }, transition: "background 0.2s" }}>
        ...
        {/* Content */}
        <Box sx={{ maxWidth: 1200, mx: "auto", px: { xs: 2, md: 5 }, py: { xs: 6, md: 10 }, display: "grid", gridTemplateColumns: { xs: "1fr", lg: "2fr 1fr" }, gap: { xs: 8, lg: 10 } }}>
