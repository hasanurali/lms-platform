    ...
    return (
        <Box sx={{
            ...
            <Box className="lesson-actions" sx={{ display: "flex", gap: 0.5, opacity: 0, transition: "opacity 0.15s" }}>
                <Tooltip title="Edit">
                    <Button onClick={() => { onLessonEdit(); onCurrentLesson(lesson) }} size="small" sx={{ minWidth: 0, px: 1.2, py: 0.3, fontSize: 10, fontWeight: 600, color: "#1a146b", bgcolor: "#e0e7ff", borderRadius: "6px", textTransform: "none", "&:hover": { bgcolor: "#c7d2fe" } }}>
                        Edit
                    </Button>
                </Tooltip>
